---
title: "How to create \"suggestionKeywordList\" Component for Instant Search App in Next.js Commerce"
...
Create file ***components/sledge/custom-components/sledge-suggestion-keyword-list.tsx*** and copy the following code for creating custom "suggestionKeywordList" component.
<CodeMDX
      ...
      <ul className="sledge-instant-search__icon-widget-search-form-result-list">
        {keywords.map((keyword: string, index: number) => {
          return (
            <li key={index}>
              <Link
                // adjust href value with your search result url
...
import SledgeSuggestionKeywordList from "components/sledge/custom-components/sledge-suggestion-keyword-list";
// ...
...
<Button
  to="https://github.com/offstack/sledge-demo-store/blob/328a5e54d57dbb995ba6bd4e2b82c6babd1a28ca/nextjs/components/sledge/instantsearch/search-header-menu.tsx#L19"
>
