...
export default function IntegrationNextPage() {
  useEffect(() => {
    gtag.event({
  ...
  return (
    <div>
      <Integration.IntegrationHero
        heroImage="/assets/images/integration-nextjs-hero.png"
        integrationType="Next.js"
        integrationDescription='Build instant search, product filters, wishlist, product review, etc. <br class="hidden md:block" />for your store using Next.js Commerce — in just a few minutes.'
      />
