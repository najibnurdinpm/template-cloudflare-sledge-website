  ...
  content: [
    {
      description: (
        <>
          ...
          carefully before using the https://sledge-app.com/ website (the
          "Service") operated by Sledge ("us", "we", or "our").
          <br />
          <br />
    ...
    },
    {
      ...
      description: (
        <>
          ...
          and will remain the exclusive property of Sledge and its licensors.
          ...
          without the prior written consent of Sledge.
        </>
      ),
    },
    {
      ...
      description: (
        <>
          ...
          that are not owned or controlled by Sledge
          <br />
          <br />
          Sledge has no control over, and assumes no responsibility for the
          ...
          <br />
          <br />
          You acknowledge and agree that Sledge shall not be responsible or
    ...
    },
    {
      ...
      description: (
        <>
          You agree to defend, indemnify and hold harmless Sledge and its
    ...
    },
    {
      ...
      description: (
        <>
          In no event shall Sledge, nor its directors, employees, partners,
    ...
    },
    {
      ...
      description: (
        <>
          ...
          <br />
          <br />
          Sledge its subsidiaries, affiliates, and its licensors do not warrant
    ...
    },
    {
      ...
      description: (
        <>
          ...
          laws of New Jersey, United States, without regard to its conflict of
          law provisions.
          <br />
          <br />
